...
// SetLevel sets the global log level used by the simple logger.
func SetLevelStr(str string) {
	beeLogger.SetLevelStr(str)
}
...
func Emergency(f interface{}, v ...interface{}) {
	beeLogger.Emergency(getMsgs(f, v...))
}

// Alert logs a message at alert level.
func Alert(f interface{}, v ...interface{}) {
	beeLogger.Alert(getMsgs(f, v...))
}

// Critical logs a message at critical level.
func Critical(f interface{}, v ...interface{}) {
	beeLogger.Critical(getMsgs(f, v...))
}

// Error logs a message at error level.
func Error(f interface{}, v ...interface{}) {
	beeLogger.Error(getMsgs(f, v...))
}

// Warn compatibility alias for Warning()
func Warn(f interface{}, v ...interface{}) {
	beeLogger.Warn(getMsgs(f, v...))
}

// Notice logs a message at notice level.
func Notice(f interface{}, v ...interface{}) {
	beeLogger.Notice(getMsgs(f, v...))
}

// Info compatibility alias for Warning()
func Info(f interface{}, v ...interface{}) {
	beeLogger.Info(getMsgs(f, v...))
}
...
func Trace(f interface{}, v ...interface{}) {
	beeLogger.Trace(getMsgs(f, v...))
}

func Emergencyf(f interface{}, v ...interface{}) {
	beeLogger.Emergency(formatLogs(f, v...))
}

func Alertf(f interface{}, v ...interface{}) {
	beeLogger.Alert(formatLogs(f, v...))
}

func Criticalf(f interface{}, v ...interface{}) {
	beeLogger.Critical(formatLogs(f, v...))
}

func Errorf(f interface{}, v ...interface{}) {
	beeLogger.Error(formatLogs(f, v...))
}

func Warnf(f interface{}, v ...interface{}) {
	beeLogger.Warn(formatLogs(f, v...))
}

func Noticef(f interface{}, v ...interface{}) {
	beeLogger.Notice(formatLogs(f, v...))
}

func Infof(f interface{}, v ...interface{}) {
	beeLogger.Info(formatLogs(f, v...))
}
...
func Tracef(f interface{}, v ...interface{}) {
	beeLogger.Trace(formatLogs(f, v...))
}

func formatLogs(f interface{}, v ...interface{}) string {
	var msg string
	switch f.(type) {
	case string:
		msg = f.(string)
...
func getMsgs(f interface{}, v ...interface{}) string {
	var msg string
	switch f.(type) {
	case string:
		msg = f.(string)
